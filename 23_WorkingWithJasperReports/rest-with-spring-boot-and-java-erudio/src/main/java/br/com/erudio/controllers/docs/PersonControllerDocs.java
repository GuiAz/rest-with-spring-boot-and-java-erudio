...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Massive People Creation",
            description = "Massive People Creation with upload with XLSX or CSV",
            tags = {"People"},
            responses = {
                    @ApiResponse(description = "Sucess", responseCode = "200", content = {
    ...
    @Operation(summary = "Export People",
            ...
            responses = {
                    @ApiResponse(description = "Sucess", responseCode = "200", content = {
                            @Content(mediaType = MediaTypes.APPLICATION_XLSX_VALUES),
                            @Content(mediaType = MediaTypes.APPLICATION_CSV_VALUES)
                    }),
                    @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
                    @ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
