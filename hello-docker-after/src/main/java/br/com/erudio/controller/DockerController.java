...
import br.com.erudio.HelloDocker;
import br.com.erudio.enviroment.InstanceInfomationService;
...
public class DockerController {
    ...
    @Autowired
    private InstanceInfomationService service;
    ...
    public HelloDocker greeting() {
        ...
        logger.info("Endpoint /hello-docker is called, AGAIN!!!!");
